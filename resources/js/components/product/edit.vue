   	               ...
   	               <div class="col-md-6">
   	                  <div class="form-group">
   					    ...
   					    <select class="form-control" id="exampleFormControlSelect1" v-model="form.category_id">
   					      <option :key="category.id" v-for="category in categories">{{ category.category_name }}</option>
   					    </select>
   	               ...
   	               <div class="col-md-6">
   	                  <div class="form-group">
   					    ...
   					    <select class="form-control" id="exampleFormControlSelect1" v-model="form.supplier_id">
   					      <option :key="supplier.id" v-for="supplier in suppliers">{{ supplier.name }}</option>
   					    </select>
